...
description: SQLAlchemy 2.0 patterns — ORM models, async sessions, relationships, queries, Alembic migrations, repository pattern, and performance optimization. Use when writing or reviewing SQLAlchemy models/queries, setting up async sessions, or fixing N+1/eager-loading issues in non-Django projects.
origin: custom
---
