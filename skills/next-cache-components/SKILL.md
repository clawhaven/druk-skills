...
description: Next.js 16 Cache Components - PPR, use cache directive, cacheLife, cacheTag, updateTag. Use when enabling cacheComponents, adding "use cache" directives, choosing cache lifetimes/tags, or invalidating cached data in Next.js 16+.
---
