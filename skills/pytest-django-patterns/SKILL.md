...
Use DRF's `APIClient` rather than the Django test client for API tests. Define fixtures in `conftest.py`:
...
Test status codes, auth (401/403 for anonymous vs authorized), and response payloads:
