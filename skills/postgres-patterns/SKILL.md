...
description: PostgreSQL database patterns for query optimization, schema design, indexing, and security. Use when choosing indexes or data types, optimizing slow queries, writing raw SQL (UPSERT, pagination, queues), or auditing a Postgres schema.
origin: ECC
---
