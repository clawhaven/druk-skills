...
description: Celery patterns for distributed task queues — task definitions, retry strategies, scheduling, chains/groups, monitoring, and production configuration with Redis/RabbitMQ. Use when writing or debugging Celery tasks, configuring workers/beat schedules, or designing background-job workflows.
origin: custom
---
