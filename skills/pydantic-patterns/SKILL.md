...
description: Pydantic v2 patterns — models, validators, serialization, computed fields, discriminated unions, settings management, and integration with FastAPI/SQLAlchemy. Use when defining or reviewing Pydantic models, writing validators, or migrating Pydantic v1 code to v2.
origin: custom
---
