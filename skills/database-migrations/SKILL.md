...
description: Database migration best practices for schema changes, data migrations, rollbacks, and zero-downtime deployments. Covers Alembic, Django, and raw SQL. Use when writing or reviewing a migration, planning a risky schema change, or asking how to migrate data without downtime.
origin: ECC
---
