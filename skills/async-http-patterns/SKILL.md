...
description: Async HTTP client patterns for Python — httpx, aiohttp, retry strategies, connection pooling, streaming, and testing with respx. Use when writing or reviewing async HTTP client code, calling external APIs from async Python, or mocking HTTP in async tests.
origin: custom
---
