...
description: FastAPI patterns for building production-grade APIs — routing, Pydantic models, dependency injection, middleware, async patterns, WebSockets, and background tasks. Use when building or reviewing FastAPI endpoints, services, or app structure.
origin: custom
---
